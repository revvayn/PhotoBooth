...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="p-6">
            <form action="{{ route('admin.frames.update', $frame) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" id="color_class" name="color_class" value="{{ old('color_class', $frame->color_class) }}"
                ...
                <div>
                    ...
                    <input type="text" id="border_class" name="border_class" value="{{ old('border_class', $frame->border_class) }}"
                ...
                <div>
                    ...
                    <input type="text" id="accent_class" name="accent_class" value="{{ old('accent_class', $frame->accent_class) }}"
                ...
                <div>
                    ...
                    <textarea id="caption" name="caption" rows="3"
                              ...
                              placeholder="Teks caption pada frame">{{ old('caption', $frame->caption) }}</textarea>
                    @error('caption')
                        <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                    @enderror
                </div>
