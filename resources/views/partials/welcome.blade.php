<div class="flex-1 flex flex-col items-center justify-center text-center py-10">
    ...
    <div class="grid grid-cols-3 gap-6 mt-14">
        <div class="flex flex-col items-center gap-2">
            <span class="w-12 h-12 rounded-2xl bg-emerald-100 flex items-center justify-center text-emerald-600">ðŸ’³</span>
            <span class="text-xs font-medium text-slate-500">Cek Pembayaran</span>
        </div>
        <div class="flex flex-col items-center gap-2">
            <span class="w-12 h-12 rounded-2xl bg-rose-100 flex items-center justify-center text-rose-600">ðŸ¤³</span>
            <span class="text-xs font-medium text-slate-500">Sesi Foto</span>
        </div>
        <div class="flex flex-col items-center gap-2">
            <span class="w-12 h-12 rounded-2xl bg-violet-100 flex items-center justify-center text-violet-600">ðŸ–¨ï¸</span>
