...
<div class="flex-1 flex flex-col items-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-xl">
        <div class="mx-auto overflow-hidden rounded-[2rem] shadow-xl shadow-rose-100 ring-1 ring-rose-100 bg-white" data-strip-container>
        ...
        <div class="flex flex-col justify-center gap-4">
            <div class="rounded-3xl bg-white/90 backdrop-blur ring-1 ring-rose-100 p-5">
                ...
                <div class="text-sm text-slate-600 space-y-1">
                    ...
                    <p>Frame: <span class="font-semibold">{{ $frameName }}</span></p>
