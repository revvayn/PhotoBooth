    ...
    <div class="flex flex-col items-center justify-center flex-1">
        @if ($metode === 'qris')
            <div class="w-full max-w-sm bg-white/95 backdrop-blur rounded-[2rem] shadow-xl shadow-rose-100 ring-1 ring-rose-100 p-8 text-center">
                <div class="w-10 h-10 mx-auto rounded-2xl bg-rose-500 text-white flex items-center justify-center text-lg mb-4"><x-icon name="card" class="w-5 h-5 text-white" /></div>
        ...
        @else
            <div class="w-full max-w-sm bg-white/95 backdrop-blur rounded-[2rem] shadow-xl shadow-rose-100 ring-1 ring-rose-100 p-8 text-center">
                <div class="w-10 h-10 mx-auto rounded-2xl from-amber-400 to-emerald-500 bg-gradient-to-br text-white flex items-center justify-center text-lg mb-4"><x-icon name="cash" class="w-5 h-5 text-white" /></div>
